...
export class CustomerLedgerService {
  /**
   * Creates an initial open customer ledger entry upon document posting.
   * Aligned with customer_ledger_entries schema.
   */
  static async createEntry(
    ...
    const res = await client.query(
      ...
      INSERT INTO customer_ledger_entries (
        ...
        $1, $2, $3, $4, $5, $6, $7, $8, 
        $9, $9, $10, $10, 
        $11, $12, true, $13, $14, $15, $16, NOW(), NOW()
      )
      RETURNING *
      `,
      [
