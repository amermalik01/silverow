// lib/validations/sales-return.schema.ts
...
export const SalesReturnAddressSchema = z.object({
  id: looseUuid,
  sales_return_id: looseUuid,
...
export const SalesReturnLineSchema = z
  .object({
    id: looseUuid,
    sales_return_id: looseUuid,
    ...
    line_total: looseNumber,
    return_reason_code: looseString,
  })
...
export const SalesReturnSchema = z.object({
  ...
  status: looseString,
  credit_status: looseString,
  shipment_status: looseString,
  invoice_status: looseString,
  source_of_return: looseString,
  source_of_order: looseString,
});

export const SalesReturnPayloadSchema = z.object({
  returnOrder: SalesReturnSchema,
  lines: z
  ...
  primary_address: SalesReturnAddressSchema.nullable().optional(),
  billing_address: SalesReturnAddressSchema.nullable().optional(),
  shipping_address: SalesReturnAddressSchema.nullable().optional(),
});

export type SalesReturnInput = z.infer<typeof SalesReturnSchema>;
export type SalesReturnAddressInput = z.infer<typeof SalesReturnAddressSchema>;
export type SalesReturnLineInput = z.infer<typeof SalesReturnLineSchema>;
export type SalesReturnPayloadInput = z.infer<typeof SalesReturnPayloadSchema>;
