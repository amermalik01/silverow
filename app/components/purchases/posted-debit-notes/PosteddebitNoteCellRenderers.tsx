// app/components/purchases/posted-debit-notes/PosteddebitNoteCellRenderers.tsx
...
export function getPostedDebitNoteCellRenderers(slug: string) {
  return {
    ...
    // Financial Amounts
    Amount: (row: DebitNote & { Amount?: number; subtotal?: number }) =>
      formatAmount(row.Amount ?? row.subtotal),
