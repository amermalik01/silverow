...
export const CustomisationModal: React.FC<Props> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm transition-opacity">
      <div className="w-full max-w-3xl rounded-xl bg-white p-6 shadow-2xl dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
        {/* Header */}
        ...
        {/* Content Table */}
        <div className="max-h-[60vh] overflow-y-auto my-4 border rounded-lg border-slate-200 dark:border-slate-800">
