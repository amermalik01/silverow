...
type ExtendedMasterData = SalesOrderMasterData & {
    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-4 shadow-sm w-full h-[210px]">
      <div className="h-full overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-12 items-center gap-2">
                ...
                <div className="col-span-8 flex gap-1">
                  ...
                  >
                    {order.link_to_po ? (
                      order.link_to_po.split(",").map((poCode) => {
            ...
            <div className="space-y-2">
              <div className="grid grid-cols-12 items-center gap-2">
                ...
                <div className="col-span-8 flex gap-1">
                  ...
                  <button
                    type="button"
                    disabled={isReadOnly || !order.customer_id}
        ...
        {activeTab === "attachments" && order.id && (
          <AttachmentsTab module="sales_order" recordId={order.id} />
        )}
      </div>
    </div>
  );
