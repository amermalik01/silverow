...
export default function PasswordSettingsTab({
  ...
  const defaultValues: PasswordSettingsData = {
  ...
  const [formData, setFormData] = useState<PasswordSettingsData>(defaultValues);

  const handleChange = <K extends keyof PasswordSettingsData>(
    field: K,
    value: string
  ) => {
  ...
  const handleCancel = () => {
    if (isEditing) {
      // Revert edits back to original saved state when canceling edit mode
        ...
        <div className="grid grid-cols-12 items-center gap-4">
          ...
          <div className="col-span-4 flex items-center">
            <input
              ...
              onChange={(e) => handleChange("expiry_time_days", e.target.value)}
              disabled={!isEditing}
              className="w-full border border-gray-300 rounded-l px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-emerald-600 bg-white disabled:bg-gray-100 disabled:text-gray-600 disabled:cursor-not-allowed"
            />
            <span className="bg-gray-100 border border-l-0 border-gray-300 text-gray-500 px-3 py-1.5 rounded-r text-xs whitespace-nowrap">
              Days
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 items-center gap-4">
          ...
          <div className="col-span-4 flex items-center">
            <input
              ...
              onChange={(e) => handleChange("reminder_start_days", e.target.value)}
              disabled={!isEditing}
              className="w-full border border-gray-300 rounded-l px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-emerald-600 bg-white disabled:bg-gray-100 disabled:text-gray-600 disabled:cursor-not-allowed"
            />
            <span className="bg-gray-100 border border-l-0 border-gray-300 text-gray-500 px-3 py-1.5 rounded-r text-xs whitespace-nowrap">
        ...
        <div className="grid grid-cols-12 items-center gap-4">
          ...
          <div className="col-span-4 flex items-center">
            <input
              ...
              disabled={!isEditing}
              className="w-full border border-gray-300 rounded px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-emerald-600 bg-white disabled:bg-gray-100 disabled:text-gray-600 disabled:cursor-not-allowed"
            />
          </div>
        </div>
