  ...
  return (
    <SetupDataGrid
      ...
      fields={[
        ...
        { name: "payable_account_id", label: "Payable Account", type: "select", options: accountOptions, required: true },
        { name: "purchase_account_id", label: "Purchase Account", type: "select", options: accountOptions, required: true },
        ...
        { name: "inventory_account_id", label: "Inventory Account", type: "select", options: accountOptions },
      ]}
      columns={[
