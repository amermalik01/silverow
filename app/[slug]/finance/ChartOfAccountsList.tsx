...
export default function ChartOfAccountsList() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Main Data Table */}
      {/* <div className="rounded-xl border dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm overflow-hidden"></div> */}
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden transition-colors duration-200">
        ...
        <div className="p-4 bg-emerald-950 px-3 py-2 text-emerald-100 border-b border-emerald-900 gap-2 flex items-center">
          ...
          <table className="w-full text-left border-collapse table-fixed min-w-[900px]">
            <thead>
              ...
              {/* <tr className="bg-slate-50/70 dark:bg-slate-800/40 text-slate-500 dark:text-slate-400 font-semibold border-b border-slate-200 dark:border-slate-800 text-[11px] capitalize tracking-wider"> */}
                <th className="p-3 pl-4 w-[10%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]">G/L No.</th>
                <th className="p-3 w-[25%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]">Account Title Name</th>
                <th className="p-3 w-[12%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]"> Category</th>
                {/* <th className="p-3 w-[12%]">Sub-Category</th>Parent */}
                <th className="p-3 w-[10%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]">Type</th>
                <th className="p-3 w-[8%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]">VAT {/* Rule */}</th>
                <th className="p-3 w-[12%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]">Calculation Range</th>
                <th className="p-3 text-right w-[10%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]">Debit</th>
                <th className="p-3 text-right w-[10%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]">Credit</th>
                <th className="p-3 text-center w-[6%] border-r border-emerald-800/80 p-2 font-bold capitalize tracking-wider text-[11px]">Action</th>
              </tr>
            </thead>
