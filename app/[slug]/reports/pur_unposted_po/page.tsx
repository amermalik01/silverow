// app/[slug]/reports/pur_unposted_po/page.tsx
"use client";
...
export default function UnpostedPurchaseOrdersReport() {
  ...
  return (
    <div className="w-full  space-y-6">
        ...
        <div className="p-6 border-b border-slate-100 bg-slate-50/50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex gap-2 items-center">
            {/* <Button
              ...
              className="border border-slate-200 text-slate-700 font-semibold px-3 py-1.5 rounded text-xs bg-white hover:bg-slate-50 flex items-center gap-1.5 shadow-sm disabled:opacity-50"
            >
      ...
      {/* Lookup Modals configured for Multi-Selection Filters */}
      <SupplierLookupModal
