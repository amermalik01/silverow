// app/[slug]/setup/purchases/page.tsx

import Breadcrumbs from "@/app/components/layout/shared/breadcrumb/BreadcrumbComp";
import PurchasesSetupForm from "@/app/components/setup/purchases/PurchasesSetupForm";

export default function GeneralPurchasesSetupPage() {
  return (
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                Configure Purchases-related master data and workflow settings.
              </p>
            </div>
          </div>
