// app/[slug]/setup/sales/page.tsx

import Breadcrumbs from "@/app/components/layout/shared/breadcrumb/BreadcrumbComp";
import SalesSetupForm from "@/app/components/setup/sales/SalesSetupForm";

export default function GeneralSalesSetupPage() {
  return (
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                Configure sales-related master data and workflow settings.
              </p>
            </div>
          </div>
