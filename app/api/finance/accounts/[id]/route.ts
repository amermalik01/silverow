...
export async function PUT(
  ...
  try {
    ...
    // FIX: Destructure the actual fields declared inside our Zod schema definition
    const {
      code,
      name,
      gl_account_type,
    ...
    // Guard against a loop reference condition
    ...
    // Determine the single-tier parent tracking ID matching our custom architecture
    ...
    try {
      ...
      // Verify transaction table usage constraints before executing structural shifts
